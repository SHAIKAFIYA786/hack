...
const problemData = {
    "AH_001": {
        ...
        "description": "Develop an AI-based healthcare assistant to provide medical information.",
        "problem_description": "• Implement a chatbot that can answer health-related queries.\n• Use NLP to understand and respond to user questions.\n• Integrate a symptom checker to provide diagnosis.\n• Ensure data privacy.",
        "field": "Healthcare, AI, NLP"
    },
    "AI_002": {
        "title": "AI for Climate Change",
        "description": "Use AI to predict and mitigate climate change effects.",
        "problem_description": "• Develop AI-based weather prediction tools.\n• Create smart solutions for energy consumption.\n• Optimize carbon footprint tracking.",
        "field": "Environment, AI, Sustainability"
    }
};
...
function openModal(problemID) {
    ...
    if (data) {
        ...
        document.getElementById("modalID").textContent = problemID;
        document.getElementById("modalDesc").textContent = data.description;
        document.getElementById("modalProblemDesc").textContent = data.problem_description.replace(/\n/g, '\n');
